...
my_list = ["a", "b", "c", "d", 2, True, 3.14, "Himanshu"]
print(type(my_list))
# my_list.append("Himanshu")  # only can append one at a time : append adds item to the end of the list
# print(my_list)
...
print(my_list.count(3.14)) # returns the occurances of an item in the list
